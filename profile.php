                    ...
                    <div class="col-md-6">
                        <div class="card h-100">
                            <div class="card-body">
                                ...
                                <a href="order-history.php" class="btn btn-outline-primary btn-sm">View History</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="card h-100">
                            <div class="card-body">
                                ...
                                <a href="favorites.php" class="btn btn-outline-primary btn-sm">Manage Favorites</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
